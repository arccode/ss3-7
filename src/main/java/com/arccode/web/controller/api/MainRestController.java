...
import com.arccode.core.security2.AuthenticationService;
import com.arccode.core.security2.TokenInfo;
import com.arccode.core.security2.TokenManager;
...
public class MainRestController {
	...
	@Secured({"ROLE_SPECIAL", "ROLE_ADMIN", "注册"})
	...
	@PreAuthorize("hasRole('ROLE_ADMIN','Dashboard')")
